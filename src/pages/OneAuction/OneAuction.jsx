    ...
    return (<>
        ...
        <div className={style.main}>
            ...
            <div>
                {products.map((product) => {
                    if (id === product._id) {
                        return <div key={product._id} className={style.inputer}>
                            <input type='number' step={100} placeholder='Введите сумму' value={priceStart} onChange={(e) => setPriceStart(e.target.value)} />
